"""
Student 360 LLM-Powered Analytics Platform - Version 4.0
=========================================================
...
Status: Production Release with Auto-Load Dataset
...
- Auto-loads Student_360_View.csv dataset by default for immediate analysis

Changes from V2:
- Auto-selects Pre-loaded Dataset option on startup (index=1)
- User can still switch to Upload File or Sample Dataset as needed
- Streamlined data loading experience
"""
...
def main():
    ...
    with st.sidebar:
        ...
        with st.expander("📝 Version 1.0 Release Notes", expanded=False):
            ...
            **Version:** 4.0
            **Release Date:** March 3, 2026
            **Status:** Production Release - Auto-Load Dataset
            """)
        ...
        data_source = st.radio(
            ...
            index=1,  # V4: Auto-select Pre-loaded Dataset
