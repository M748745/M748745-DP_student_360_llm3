"""
Student 360 LLM-Powered Analytics Platform - Version 3.0
=========================================================
...
Status: Production Release with Auto-Loading Dataset
...
def auto_load_dataset():
    ...
    This is a NEW feature in Version 3.0 that eliminates manual data loading.
    """
    ...
    # Define the dataset path - try multiple locations
    script_dir = os.path.dirname(os.path.abspath(__file__))

    # Try multiple path options for flexibility
    path_options = [
        r"D:\exalio_work\RFP\Ankbut\MVP\cons\LLM\data\Student_360_View.csv",  # Direct path
        os.path.join(script_dir, "data", "Student_360_View.csv"),  # Relative to script
        os.path.join(os.path.dirname(script_dir), "data", "Student_360_View.csv"),  # Parent directory
    ]
    ...
    if dataset_path is None:
        # Dataset not found - user will need to upload manually
