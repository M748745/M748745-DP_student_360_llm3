"""
Student 360 LLM-Powered Analytics Platform - Version 3.1 Final
===============================================================
...
Status: Production Release - Pre-loaded Dataset (Auto-Selected)
...
def main():
    ...
    with st.sidebar:
        ...
        data_source = st.radio(
            ...
            index=1,  # V3.1: Default to Pre-loaded Dataset
